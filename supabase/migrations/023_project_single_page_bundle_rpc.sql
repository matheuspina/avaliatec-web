-- Bundle único para a single page de projeto
-- Retorna: projeto, tarefas, colunas, arquivos, membros, status, perfis e resumo de checklist
...
COMMENT ON FUNCTION public.get_project_single_page_bundle(uuid)
IS 'Bundle único para single page de projetos: projeto, colunas, tarefas, arquivos, membros, status, perfis e resumo de checklist (RLS do chamador).';

REVOKE ALL ON FUNCTION public.get_project_single_page_bundle(uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_project_single_page_bundle(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_project_single_page_bundle(uuid) TO service_role;
